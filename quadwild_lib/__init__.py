...
class Quadwild():
    def __init__(self, mesh_path: str) -> None:
        ...
        if system == "Windows":
            ...
            quadwild_lib_filename = 'lib_quadwild.dylib'
            quadpatches_lib_filename = 'lib_quadpatches.dylib'
        else:
            quadwild_lib_filename = 'lib_quadwild.so'
            quadpatches_lib_filename = 'lib_quadpatches.so'
